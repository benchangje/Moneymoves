                    ...
                    <form onSubmit={handleUpload} className="w-full">
                        ...
                        <div className="pb-6 hover:scale-101 transition-all duration-400 ease-out">
                            <input
                                ...
                                className={`w-full bg-[#eceef2] rounded-xl px-5 py-3 text-gray-400 focus:text-gray-600 placeholder-gray-400 focus:outline-none focus:placeholder-gray-400 hover:bg-gray-200 transition-all duration-400 ease-out`}
                            />
                        </div>
                            ...
                            >
                                <div className="flex items-center justify-between gap-4">
                                    {selectedCategory !== "Select a category" && (() => {
                                        ...
                                        return ActiveIcon ? <ActiveIcon className={`w-5 h-5 sm:h-5 sm:w-5 ${categoryIsOpen ? "text-gray-600" : "text-gray-400"}`} /> : null;
                                    })()}
                                    <div className={`${categoryIsOpen ? "text-gray-600" : "text-gray-400"}`}>
                                        {selectedCategory}
                                    </div>
                                </div>
                        ...
                        <div className="w-full flex-col space-x-8">
                            ...
                            <div className="relative z-20 w-full hover:scale-101 transition-all duration-400 ease-out" ref={lendingRef}>
                                <button 
                                    type="button"
                                    className={`w-full bg-[#eceef2] flex items-center justify-between text-left mt-6 text-gray-400 rounded-xl px-5 py-3 text-base hover:bg-gray-200 transition-colors ${lendingIntervalIsOpen ? "border-gray-500" : "border-gray-400"}`} 
                                    onClick={() => setLendingIntervalIsOpen(!lendingIntervalIsOpen)}
                                >
                                    <div className="flex items-center justify-start space-x-4">
                                        <CalendarDays className={`w-5 h-5 sm:h-5 sm:w-5 ${lendingIntervalIsOpen ? "text-gray-600" : "text-gray-400"}`} />
                                        <div className={`${lendingIntervalIsOpen ? "text-gray-600" : "text-gray-400"}`}>
